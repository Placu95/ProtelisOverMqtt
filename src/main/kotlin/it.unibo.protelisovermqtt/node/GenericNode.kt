...
abstract class GenericNode(
    ...
    constructor(
        ...
        initialPosition: LatLongPosition,
        neighbors: Set<StringUID> = emptySet()
    ) : this(protelisProgram, sleepTime, deviceUID, applicationUID, mqttClient, mqttClient, initialPosition, neighbors)
    ...
    protected val networkManager =
        MQTTNetMgrWithMQTTNeighborhoodMgr(deviceUID, netManagerMqttClient, applicationUID, position, neighbors)
