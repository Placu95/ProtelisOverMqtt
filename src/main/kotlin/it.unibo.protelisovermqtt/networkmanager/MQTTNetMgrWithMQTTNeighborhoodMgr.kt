...
open class MQTTNetMgrWithMQTTNeighborhoodMgr(
    ...
    init {
        mqttClient.subscribe(this, Topics.neighborhoodTopic(applicationEUI), NewNeighborhoodMessage::class.java) {
            _, message ->
        ...
        if (neighbors.isEmpty()) {
            mqttClient.publish(Topics.neighborhoodManagerTopic(applicationEUI), generateMessage(MessageType.ADD, deviceUID, initialPosition))
        } else {
